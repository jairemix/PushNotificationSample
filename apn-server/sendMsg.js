...
var deviceToken = '64a2535473a4a0c92dcc2f0dfcc7672cd4524d4630767a6609a2d3d0d8bfae6e';

console.log('apn', apn);

// var myDevice = new apn.Device(iPhone);

var options = {
    token: {
        key: "Certificates-warrenjoe92.p12",
        keyId: "T0K3NK3Y1D",
        teamId: "T34M1D",
    },
    production: false,
...
note.payload = {'messageFrom': 'dsgdsgdsg'};
note.topic = "org.warrenjoe92.push.sample";
